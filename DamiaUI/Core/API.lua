...
if ns.LogDebug then
    ns:LogDebug("API.lua: ns.ErrorCapture initialized = " .. tostring(ns.ErrorCapture))
end
local errorLogs = {}
...
if ns.LogDebug then
    ns:LogDebug("API.lua: ns.ErrorCapture.SafeCall defined = " .. tostring(ns.ErrorCapture.SafeCall))
end
