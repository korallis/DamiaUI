--------------------------------------------------------------------
-- DamiaUI Misc - Loot Roll Frame
-- Based on ColdUI by Coldkil (teksloot), adapted for DamiaUI and WoW 11.2
--------------------------------------------------------------------
...
-- Module registration
ns:RegisterModule("RollFrame", RollFrame)

function RollFrame:Initialize()
    self:SetupRollFrame()
end

function RollFrame:SetupRollFrame()
    ...
    local function CreateRollFrame()
        ...
        status:SetStatusBarTexture(ns.media.texture)
        ...
        -- Roll buttons
        local need, needtext = CreateRollButton(frame, 
            ...
            1, NEED, "LEFT", frame.button, "RIGHT", 5, -1)
            
        local greed, greedtext = CreateRollButton(frame, 
            ...
            2, GREED, "LEFT", need, "RIGHT", 0, -1)
            
        local de, detext = CreateRollButton(frame, 
            "Interface\\Buttons\\UI-GroupLoot-DE-Up", 
            "Interface\\Buttons\\UI-GroupLoot-DE-Highlight", 
            "Interface\\Buttons\\UI-GroupLoot-DE-Down", 
            3, ROLL_DISENCHANT, "LEFT", greed, "RIGHT", 0, -1)
            
        local pass, passtext = CreateRollButton(frame, 
            "Interface\\Buttons\\UI-GroupLoot-Pass-Up", 
            nil, 
            "Interface\\Buttons\\UI-GroupLoot-Pass-Down", 
            0, PASS, "LEFT", de or greed, "RIGHT", 0, 2.2)
    ...
    -- Localization for roll messages
