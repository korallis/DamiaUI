...
local function skinbubble(frame)
	...
	for i=1, frame:GetNumRegions() do
		...
		elseif region:GetObjectType() == "FontString" then
			frame.text = region
			frame.text:SetFont(font, fs*offset, "OUTLINE, MONOCHROME")
		end
	end
...
local _DEFAULTS = {
	width = 250,
	height = 13,
	texture = "Interface\\AddOns\\ColdMisc\\media\\flat2",
...
do
	...
	function Spawn(type)
		...
		text:SetFont(font, fs, "OUTLINE, MONOCHROME")
