...
local backdrop = {
	bgFile = "Interface\\AddOns\\ColdMisc\\media\\flat2", tile = true, tileSize = 0,
	edgeFile = "Interface\\AddOns\\ColdMisc\\media\\flat2", edgeSize = 1,
...
local function CreateRollFrame()
	...
	status:SetStatusBarTexture("Interface\\AddOns\\ColdMisc\\media\\flat2")
