  ...
  local bar = CreateFrame("Frame","ColdBar3",UIParent, "SecureHandlerStateTemplate")
  ...
  bar:SetPoint("BOTTOM",ColdBar2,"TOP",0,0)
  B.makedrag(bar)
  ...
  if cfg.num < 12 then
    for y=cfg.num+1, 12 do
	  local button = _G["MultiBarBottomRightButton"..y]
  ...
  RegisterStateDriver(MultiBarBottomRight, "visibility", "[petbattle][overridebar][vehicleui] hide; show")