  ...
  local function durationSetText(duration, arg1, arg2)
    duration:SetText(format("|cffffffff"..arg1.."|r",arg2))
  end
  ...
  local function applySkin(b,type)
    ...
    --duration
    b.duration:SetFont(cfg.font, cfg.duration.fontsize, "OUTLINE, MONOCHROME")
    ...
    --count
    b.count:SetFont(cfg.font, cfg.count.fontsize, "OUTLINE, MONOCHROME")
    b.count:ClearAllPoints()
    b.count:SetPoint(cfg.count.pos.a1,cfg.count.pos.x,cfg.count.pos.y)
	b.count:SetTextColor(0,1,0)
